      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            <Link href="/wishlist">
              <AiOutlineHeart size={24} className="hover:text-emerald-300 cursor-pointer" />
            </Link>
            <Link href="/cart">
              <BsFillCartFill size={24} className="hover:text-emerald-300 cursor-pointer" />
            </Link>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden space-y-2 mt-2">
            ...
            <Link href="/cart" className="block hover:bg-emerald-500 px-3 py-2 rounded">Cart</Link>
          </div>
        )}
      </div>
    </nav>
